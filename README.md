...
Create, and start the mariadb Gearbox container with version  and run a shell.

`./bin/gb-launch -gb-name mariadb -gb-version  -gb-shell`
...
`./bin/gb-launch -gb-name mariadb -gb-version  -flag1 -flag2 variable`
...
`./bin/gb-launch -gb-name mariadb -gb-version  -gb-shell -- ls -l`

`./bin/mariadb -gb-shell -- ps -eaf`

`./bin/gb-launch -gb-name mariadb -gb-version  -gb-shell -- ps -eaf`
